...
public class ConditionalStatement {
    public static void main(String[] args) {
        ...
        String name = scanner.nextLine(); //엔터 이전까지의 문자열을 받는다.
        System.out.println("name 값 확인 : " + name);

        //Bad ('==' 대입 연산자 사용하면 비교 불가.)
//        if(name == "김새싹"){
...
//        }
        ...
        //WHY?
        // '=='연산자 : 두 객체의 참조를 비교 (동일한 메모리 위치를 가르키는지 확인).
        // '.equals()' 메서드 : 두 객체의 "내용"이 동일한지 비교.

        //String 만드는 데에 차이도 있다.
        //"문자열 리터럴"의 경우, Java에서 특별한 취급을 한다.
        ...
        //문자열 "동적 할당"의 경우 , new String(...)을 사용해서 새로운 문자열 객체를 생성 -> 서로 다른 객체를 가르킨다.
        //new String으로 문자열 객체를 새로 만드는 거기때문에 다른 객체가 된다.
        //str3, str4 가 다른 객체이므로, '=='연산자로 비교 시 false.
        //따라서 문자열(내용) 비교 시 'equals.()'메서드로 비교하는 것이 바람직.
        ...
        /////////////////////////////
        // switch ~ case 문
        // 각 case 문의 break 문은 선택 사항, break 문 생략 시 바로 밑의 case 문으로 넘어감.
        String dayOfWeek;
        int day = 4;
